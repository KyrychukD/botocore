    ...
    def create_distribution(self, **kwargs):
        ...
        **Request Syntax** 
        ...
        :param DistributionConfig: **[REQUIRED]** The distribution's configuration information.
          ...
          - **Aliases** *(dict) --* **[REQUIRED]** A complex type that contains information about CNAMEs (alternate domain names), if any, for this distribution.
          ...
          - **DefaultCacheBehavior** *(dict) --* **[REQUIRED]** A complex type that describes the default cache behavior if you do not specify a CacheBehavior element or if files don't match any of the values of PathPattern in CacheBehavior elements.You must create exactly one default cache behavior.
            ...
            - **AllowedMethods** *(dict) --* A complex type that controls which HTTP methods CloudFront processes and forwards to your Amazon S3 bucket or your custom origin. There are two options: - CloudFront forwards only GET and HEAD requests. - CloudFront forwards DELETE, GET, HEAD, OPTIONS, PATCH, POST, and PUT requests. If you choose the second option, you may need to restrict access to your Amazon S3 bucket or to your custom origin so users can't perform operations that you don't want them to. For example, you may not want users to have permission to delete objects from your origin.
              ...
              - **Quantity** *(integer) --* **[REQUIRED]** The number of HTTP methods that you want CloudFront to forward to your origin. Valid values are 2 (for GET and HEAD requests) and 7 (for DELETE, GET, HEAD, OPTIONS, PATCH, POST, and PUT requests).
          ...
          - **CacheBehaviors** *(dict) --* **[REQUIRED]** A complex type that contains zero or more CacheBehavior elements.
          ...
          - **Logging** *(dict) --* **[REQUIRED]** A complex type that controls whether access logs are written for the distribution.
          ...
          - **PriceClass** *(string) --* **[REQUIRED]** A complex type that contains information about price class for this distribution.
              ...
              - **DistributionConfig** *(dict) --* The current configuration information for the distribution.
                ...
                - **DefaultCacheBehavior** *(dict) --* A complex type that describes the default cache behavior if you do not specify a CacheBehavior element or if files don't match any of the values of PathPattern in CacheBehavior elements.You must create exactly one default cache behavior.
                  ...
                  - **AllowedMethods** *(dict) --* A complex type that controls which HTTP methods CloudFront processes and forwards to your Amazon S3 bucket or your custom origin. There are two options: - CloudFront forwards only GET and HEAD requests. - CloudFront forwards DELETE, GET, HEAD, OPTIONS, PATCH, POST, and PUT requests. If you choose the second option, you may need to restrict access to your Amazon S3 bucket or to your custom origin so users can't perform operations that you don't want them to. For example, you may not want users to have permission to delete objects from your origin.
                    ...
                    - **Quantity** *(integer) --* The number of HTTP methods that you want CloudFront to forward to your origin. Valid values are 2 (for GET and HEAD requests) and 7 (for DELETE, GET, HEAD, OPTIONS, PATCH, POST, and PUT requests).
    ...
    def create_streaming_distribution(self, **kwargs):
        ...
        **Request Syntax** 
        ...
        :param StreamingDistributionConfig: **[REQUIRED]** The streaming distribution's configuration information.
          ...
          - **Aliases** *(dict) --* **[REQUIRED]** A complex type that contains information about CNAMEs (alternate domain names), if any, for this streaming distribution.
          ...
          - **Logging** *(dict) --* **[REQUIRED]** A complex type that controls whether access logs are written for the streaming distribution.
          ...
          - **PriceClass** *(string) --* **[REQUIRED]** A complex type that contains information about price class for this streaming distribution.
