...
class EC2(BaseClient):
    ...
    def allocate_address(self, **kwargs):
        ...
        An Elastic IP address is for use either in the EC2-Classic platform or in a VPC. For more information, see `Elastic IP Addresses <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/elastic-ip-addresses-eip.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def attach_volume(self, **kwargs):
        ...
        Encrypted Amazon EBS volumes may only be attached to instances that support Amazon EBS encryption. For more information, see `Amazon EBS Encryption <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
        ...
        * AWS Marketplace product codes are copied from the volume to the instance.
        ...
        For an overview of the AWS Marketplace, see `https\://aws.amazon.com/marketplace/help/200900000 <https://aws.amazon.com/marketplace/help/200900000>`__ . For more information about how to use the AWS Marketplace, see `AWS Marketplace <https://aws.amazon.com/marketplace>`__ .
        
         
        
        For more information about Amazon EBS volumes, see `Attaching Amazon EBS Volumes <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-attaching-volume.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
        ...
        :param IpPermissions: 
          ...
          - *(dict) --* 
            ...
            - **IpProtocol** *(string) --* 
              ...
              When you call  DescribeSecurityGroups , the protocol value returned is the number. Exception: For TCP, UDP, and ICMP, the value returned is the name (for example, ``tcp`` , ``udp`` , or ``icmp`` ). For a list of protocol numbers, see `Protocol Numbers <http://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml>`__ .
    ...
    def cancel_conversion_task(self, **kwargs):
        ...
        For more information, see `Using the Command Line Tools to Import Your Virtual Machine to Amazon EC2 <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/UploadingYourInstancesandVolumes.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def cancel_spot_instance_requests(self, **kwargs):
        """Cancels one or more Spot Instance requests. Spot Instances are instances that Amazon EC2 starts on your behalf when the maximum price that you specify exceeds the current Spot Price. Amazon EC2 periodically sets the Spot Price based on available Spot Instance capacity and current Spot Instance requests. For more information about Spot Instances, see `Spot Instances <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-spot-instances.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def copy_image(self, **kwargs):
        ...
        For more information, see `Copying AMIs <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/CopyingAMIs.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def create_instance_export_task(self, **kwargs):
        ...
        For information about the supported operating systems, image formats, and known limitations for the types of instances you can export, see `Exporting EC2 Instances <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ExportingEC2Instances.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def create_network_interface(self, **kwargs):
        ...
        For more information about network interfaces, see `Elastic Network Interfaces <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-eni.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
        ...
        **Request Syntax** 
        ...
        :param SecondaryPrivateIpAddressCount: 
          ...
          The number of IP addresses you can assign to a network interface varies by instance type. For more information, see `Private IP Addresses Per ENI Per Instance Type <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-eni.html#AvailableIpPerENI>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def create_placement_group(self, **kwargs):
        ...
        For more information about placement groups and cluster instances, see `Cluster Instances <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using_cluster_computing.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def create_reserved_instances_listing(self, **kwargs):
        ...
        **Request Syntax** 
        ...
        :param ClientToken: **[REQUIRED]** 
          ...
          Unique, case-sensitive identifier you provide to ensure idempotency of your listings. This helps avoid duplicate listings. For more information, see `Ensuring Idempotency <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Run_Instance_Idempotency.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def create_spot_datafeed_subscription(self, **kwargs):
        """Creates a datafeed for Spot Instances, enabling you to view Spot Instance usage logs. You can create one data feed per AWS account. For more information, see `Spot Instances <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-spot-instances.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def create_tags(self, **kwargs):
        ...
        For more information about tags, see `Tagging Your Resources <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def create_volume(self, **kwargs):
        ...
        For more information, see `Creating or Restoring an Amazon EBS Volume <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-creating-volume.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def delete_spot_datafeed_subscription(self, **kwargs):
        """Deletes the datafeed for Spot Instances. For more information, see `Spot Instances <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-spot-instances.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def describe_availability_zones(self, **kwargs):
        ...
        For more information, see `Regions and Availability Zones <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def describe_conversion_tasks(self, **kwargs):
        """Describes one or more of your conversion tasks. For more information, see `Using the Command Line Tools to Import Your Virtual Machine to Amazon EC2 <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/UploadingYourInstancesandVolumes.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def describe_instance_status(self, **kwargs):
        ...
        * Scheduled Stop: When Amazon EC2 determines that an instance must be shut down, the instances status returns an event code called ``instance-stop`` . Stop events include a scheduled start and end time. You will also be notified by email if one of your instances is set to stop. The email message indicates when your instance will be stopped. 
        ...
        For more information about failed status checks, see `Troubleshooting Instances with Failed Status Checks <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/TroubleshootingInstances.html>`__ in the *Amazon Elastic Compute Cloud User Guide* . For more information about working with scheduled events, see `Working with an Instance That Has a Scheduled Event <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/monitoring-instances-status-check_sched.html#schedevents_actions>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def describe_placement_groups(self, **kwargs):
        """Describes one or more of your placement groups. For more information about placement groups and cluster instances, see `Cluster Instances <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using_cluster_computing.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def describe_reserved_instances(self, **kwargs):
        ...
        For more information about Reserved Instances, see `Reserved Instances <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/concepts-on-demand-reserved-instances.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
        ...
        **Request Syntax** 
        ::
          ...
          response = client.describe_reserved_instances(
              ...
              OfferingType='Heavy Utilization'|'Medium Utilization'|'Light Utilization'
          )
        :type DryRun: boolean
        :param DryRun: 
    ...
    def describe_reserved_instances_offerings(self, **kwargs):
        ...
        **Request Syntax** 
        ...
        :param InstanceType: 
          ...
          The instance type on which the Reserved Instance can be used. For more information, see `Instance Types <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def describe_snapshot_attribute(self, **kwargs):
        ...
        For more information about Amazon EBS snapshots, see `Amazon EBS Snapshots <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSSnapshots.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def describe_spot_datafeed_subscription(self, **kwargs):
        """Describes the datafeed for Spot Instances. For more information, see `Spot Instances <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-spot-instances.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def describe_spot_instance_requests(self, **kwargs):
        ...
        **Request Syntax** 
        ...
        :param Filters: 
          ...
          * ``state`` - The state of the Spot Instance request (``open`` | ``active`` | ``closed`` | ``cancelled`` | ``failed`` ). Spot bid status information can help you track your Amazon EC2 Spot Instance requests. For information, see `Tracking Spot Requests with Bid Status Codes <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-spot-instances-bid-status.html>`__ in the Amazon Elastic Compute Cloud User Guide. 
            ...
            - **SpotInstanceRequests** *(list) --* 
              ...
              - *(dict) --* 
                ...
                - **State** *(string) --* 
                  ...
                  The state of the Spot Instance request. Spot bid status information can help you track your Spot Instance requests. For information, see `Tracking Spot Requests with Bid Status Codes <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-spot-instances-bid-status.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def describe_volume_attribute(self, **kwargs):
        ...
        For more information about Amazon EBS volumes, see `Amazon EBS Volumes <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumes.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def import_instance(self, **kwargs):
        """Creates an import instance task using metadata from the specified disk image. After importing the image, you then upload it using the ec2-import-volumecommand in the EC2 command line tools. For more information, see Using the Command Line Tools to Import Your Virtual Machine to Amazon EC2in the Amazon Elastic Compute Cloud User Guide.
    ...
    def import_volume(self, **kwargs):
        """Creates an import volume task using metadata from the specified disk image. After importing the image, you then upload it using the ec2-import-volumecommand in the Amazon EC2 command-line interface (CLI) tools. For more information, see `Using the Command Line Tools to Import Your Virtual Machine to Amazon EC2 <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/UploadingYourInstancesandVolumes.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def modify_snapshot_attribute(self, **kwargs):
        ...
        For more information on modifying snapshot permissions, see `Sharing Snapshots <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-modifying-snapshot-permissions.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def monitor_instances(self, **kwargs):
        """Enables monitoring for a running instance. For more information about monitoring instances, see `Monitoring Your Instances and Volumes <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-cloudwatch.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def run_instances(self, **kwargs):
        ...
        If you don't specify a security group when launching an instance, Amazon EC2 uses the default security group. For more information, see `Security Groups <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-network-security.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
        ...
        You can provide optional user data when launching an instance. For more information, see `Instance Metadata <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/AESDG-chapter-instancedata.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
        ...
        **Request Syntax** 
        ...
        :param ClientToken: 
          ...
          Unique, case-sensitive identifier you provide to ensure the idempotency of the request. For more information, see `How to Ensure Idempotency <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Run_Instance_Idempotency.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def stop_instances(self, **kwargs):
        ...
        For more information about troubleshooting, see `Troubleshooting Stopping Your Instance <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/TroubleshootingInstancesStopping.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def unmonitor_instances(self, **kwargs):
        """Disables monitoring for a running instance. For more information about monitoring instances, see `Monitoring Your Instances and Volumes <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-cloudwatch.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
