...
class EC2(BaseClient):
        ...
        **Request Syntax** 
        ::
          ...
          response = client.describe_image_attribute(
              DryRun=True|False,
              ImageId='string',
              Attribute='description'|'kernel'|'ramdisk'|'launchPermission'|'productCodes'|'blockDeviceMapping'
          )
        :type DryRun: boolean
        :param DryRun: 
    ...
    def import_instance(self, **kwargs):
        """Creates an import instance task using metadata from the specified disk image. After importing the image, you then upload it using the ``ec2-import-volume`` command in the EC2 command line tools. For more information, see `Using the Command Line Tools to Import Your Virtual Machine to Amazon EC2 <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/UploadingYourInstancesandVolumes.html>`__ in the *Amazon Elastic Compute Cloud User Guide for Linux* .
