...
class MarketplaceCommerceAnalytics(BaseClient):
    ...
    def generate_data_set(self, **kwargs):
        ...
        **Request Syntax** 
        ...
        """
        return self._make_api_call("GenerateDataSet", kwargs)

    def start_support_data_export(self, **kwargs):
        ...
        **Request Syntax** 
        ...
        """
        return self._make_api_call("StartSupportDataExport", kwargs)
